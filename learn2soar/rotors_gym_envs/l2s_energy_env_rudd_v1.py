...
class AlbatrossEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.time_step = 0.3
        self.ail_cmd_limit = 0.167 * np.pi
        self.elev_cmd_limit = 0.167 * np.pi
        self.rudd_cmd_limit = 0.15 * np.pi
        ...
        self.rudd_pub   = rospy.Publisher("/uav_1/rudd_pos", Float32, queue_size=1)
    ...
    def reset(self):
        ...
        observation, _, _, _ = self.step([0.0,0.0, 0.0])
    ...
    def _apply_action(self, action):
        ...
        self.rudd_cmd  = action[2] * self.rudd_cmd_limit
        ...
        self.rudd_pub.publish(Float32(self.rudd_cmd))
